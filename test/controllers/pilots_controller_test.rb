...
class PilotsControllerTest < ActionController::TestCase
  ...
  test "should create pilot" do
    assert_difference('Pilot.count') do
      post :create, pilot: { city: @pilot.city, email: @pilot.email, firstname: @pilot.firstname, lastname: @pilot.lastname, phone: @pilot.phone }
    end
  ...
  test "should update pilot" do
    patch :update, id: @pilot, pilot: { city: @pilot.city, email: @pilot.email, firstname: @pilot.firstname, lastname: @pilot.lastname, phone: @pilot.phone }
    assert_redirected_to pilot_path(assigns(:pilot))
  end
